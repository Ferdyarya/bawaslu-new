                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="">
                                ...
                                @endif
                            <!-- form start -->
                            <form action="{{ route('evaluasi.update', $item->id) }}" class="w-full" method="POST"
                                ...
                                <div class="card-body mb-3">
                                    <div class="form-group">
                                        <label for="id_laporan">No Surat</label>
                                          ...
                                          <input type="hidden" name="id_laporan" id="id_laporan" value="{{ $item->id_laporan }}">
                                        </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea name="deskripsi" class="form-control" rows="4" placeholder="Deskripsi..." required>{{ $item->deskripsi }}</textarea>
                                        </div>
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <select name="penilaian" class="custom-select form-control-border" id="penilaian">
                                                <option value="A" {{ $item->penilaian == 'A' ? 'selected' : '' }}>A</option>
                                                <option value="B" {{ $item->penilaian == 'B' ? 'selected' : '' }}>B</option>
                                                <option value="C" {{ $item->penilaian == 'C' ? 'selected' : '' }}>C</option>
                                                <option value="D" {{ $item->penilaian == 'D' ? 'selected' : '' }}>D</option>
                                                <option value="E" {{ $item->penilaian == 'E' ? 'selected' : '' }}>E</option>
                                              </select>
                                            </div>
                                </div>
                                <!-- /.card-body -->
