                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/pengawasan">Data Pengawasan Laporan</a></li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Data pengawasan Laporan</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="">
                                {{-- handling error --}}
                                ...
                                @endif
                            <!-- form start -->
                            <form action="{{ route('pengawasan.update', $item->id) }}" class="w-full" method="POST"
                                ...
                                <div class="card-body mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea name="tujuan" class="form-control" rows="4" placeholder="tujuan...">{{ $item->tujuan }}</textarea>
                                        </div>
                                    <div class="form-group">
                                                <label for="penempatan">Total Anggaran</label>
                                                <input value="{{ $item->penempatan }}" name="penempatan" type="text" class="form-control" id="penempatan" placeholder="Masukan Penempatan">
                                    </div>
                                        <div class="form-group">
