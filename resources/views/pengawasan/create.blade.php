                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="">
                                ...
                                @endif
                            <!-- form start -->
                            <form action="{{ route('pengawasan.store') }}" class="w-full" method="POST"
                    enctype="multipart/form-data">
                                ...
                                <div class="card-body mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('penempatan') }}" name="penempatan[]" type="text" class="form-control" id="penempatan" placeholder="Masukan Penempatan"  required>
                                    </div>
                                    <div class="form-group">
                                          <label>Keterangan</label>
                                          <textarea name="tujuan[]" class="form-control" rows="4" placeholder="tujuan..."  required>{{ old('tujuan') }}</textarea>
                                    </div>
                                        <div class="form-group">
